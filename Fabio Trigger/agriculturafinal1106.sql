...
usuario)
VALUES
(CONCAT('DELETE FROM maquinario WHERE id = ', OLD.id_maquina, ';'),"Maquinario",NOW(),USER());
END //
DELIMITER ;
...
usuario)
VALUES
(CONCAT('UPDATE maquinario SET tipo = ', NEW.tipo, ', modelo = ', NEW.modelo, ', data_aquisicao = ', NEW.data_aquisicao, ', valor_hora = ', NEW.valor_hora, ' WHERE id = ', OLD.id_maquina, ';'),"Maquinario",NOW(),USER());
END //
DELIMITER ;
...
('Fazenda Joaquim Ferreira', 'Zona Rural, Muzambinho', 200.50, 7);
...
('Colheitadeira', 'Case IH 5480', '2022-08-15', 250.00, 19),
('Trator', 'Jhe-21', '2020-08-15', 200.00, 17),
('Trator', 'lad-123', '2012-08-15', 2500.00, 18),
('Colheitadeira', 'Case IH 5480', '2022-08-15', 250.00, 19),
('Carro', 'Ford ka', '2023-06-25', 15000.00, 19),
('Caminhão', 'HJq09', '2013-01-10', 90000.00, 19);
